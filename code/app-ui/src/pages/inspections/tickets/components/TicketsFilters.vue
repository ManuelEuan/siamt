...
<span>Agregar trabajo</span>
            ...
            <v-tooltip v-if="permissions.includes('crit')" top>
                <template v-slot:activator="{ on, attrs }">
                    <v-btn color="primary" class="me-1" @click="downloadTickets" v-bind="attrs" v-on="on">
                ...
                <v-dialog v-model="dialog" width="600">
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-row dense>
                                <v-col cols="12" md="6">
                                    <v-text-field v-model="filters.nombre_empleado" label="Nombre empleado" hide-details="auto" clearable
                                        dense outlined></v-text-field>
                                </v-col>
                                <v-col cols="12" md="6">
                                    <v-text-field v-model="filters.nombre_infractor" label="Nombre infractor" hide-details="auto"
    ...
    methods: {
        ...
        async downloadTickets() {
            try {
                ...
                const response = await services.inspections().downloadTickets();
