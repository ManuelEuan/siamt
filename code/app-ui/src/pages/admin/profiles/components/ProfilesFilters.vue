                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-row dense>
                            ...
                            <v-col cols="6" md="6">
                                <v-select v-model="filters.roles" label="Perfiles" :items="items.roles" item-text="nombre" item-value="id" clearable dense hide-details multiple outlined small-chips></v-select>
                            </v-col>
                            <v-col cols="12" md="6">
                                <v-text-field v-model="filters.username" label="Usuario" hide-details="auto" clearable dense outlined></v-text-field>
                            </v-col>
                            <v-col cols="12" md="6">
