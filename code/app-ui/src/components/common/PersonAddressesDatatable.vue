...
<template>
    <div class="wrapper">
        ...
        <v-data-table class="elevation-1" loading-text="Cargando información" :headers="headers" :items="inspectors"
            :page-count="inspectorsTotalPages" :server-items-length="inspectorsTotalItems" :options.sync="options"
