<template>
  <v-app>
    <script type="application/javascript" :src="googleMapsApiUrl"></script>
    <!-- Layout component -->
...
export default {
  ...
  computed: {
    googleMapsApiUrl () {
      return `https://maps.googleapis.com/maps/api/js?v=3.exp&key=${config.maps.key}&libraries=places&callback=Function.prototype`;
    },
    ...mapState('app', ['toast']),
