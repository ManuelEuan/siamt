...
class TypesAddress extends Model
{
    public function initialize()
    {
        $this->setSchema("persona");
        $this->setSource("tbl_persona_direccion");
    }

    public function getSequenceName()
    {
        return "persona.tbl_persona_direccion_iid_seq";
    }

    public static function getAllTypesAddress($bactivo = null)
    {
        $parameters = [];
        $conditions = [];
