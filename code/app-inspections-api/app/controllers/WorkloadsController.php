...
class WorkloadsController extends BaseController
{
    ...
    //     }
    //     // var_dump($data->sortBy);
    //     // var_dump($data->sortDesc);exit;
    ...
    //                 $sql2 .= "inspectores.txttarjeton ILIKE :tarjeton "; // Condición para nombre (ignorando mayúsculas y minúsculas)
    ...
    //                     break;
    //                 case 'txttarjeton': // Ordenar por usuario
    //                     $sql .= 'inspectores.txttarjeton '; // Agregar columna de usuario
    //                     break;
    ...
    //         return 0;
    //     }
    //     $sql2 = "SELECT iidpersona, txttarjeton
    ...
    //     }
    //     // var_dump($persona->isInspector);exit;
    //     return $persona;
    // }
    ...
    //             comun.cat_etapa ce
    //         JOIN 
    //             comun.tbl_proceso tp ON ce.iidproceso = tp.iidproceso
    //         JOIN 
    ...
    //         'txttarjeton' => $data->txttarjeton,
    //         'iidturno' => $data->iidturno,
    //         'txtfolio' => $data->txtfolio,
    //         'iidinspector_categoria' => $data->iidinspector_categoria,
    //         'dvigencia' => $data->dvigencia !== '' ? $data->dvigencia : null,
    ...
    // {
    //     $requiredKeys = array('txttarjeton', 'iidturno', 'iidinspector_categoria', 'dfecha_alta'); // Claves requeridas
